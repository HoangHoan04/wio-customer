...
export default function BottomToolbar({
  ...
  return (
    <div className="h-12 bg-[#252525] border-b border-[#333] flex items-center justify-between px-4 shrink-0 overflow-x-auto select-none">
      <div className="flex items-center gap-1">
        <button
          onClick={onZoomToFit}
          className="flex items-center gap-1.5 px-2.5 py-1.5 text-gray-400 hover:text-white hover:bg-[#3a3a3a] rounded text-xs transition-colors"
      ...
      {hasSelection && (
        <div className="flex items-center gap-1" key={selectedElement.id}>
          ...
          <span className="text-[11px] text-gray-600 font-mono ml-1 whitespace-nowrap">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-[11px] text-gray-600 font-mono">Zoom: {zoom}%</span>
      </div>
    </div>
  );
}
