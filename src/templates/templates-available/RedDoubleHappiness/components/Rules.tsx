  ...
  return (
    ...
    >
      <img
        ...
        alt=""
        aria-hidden="true"
        className="absolute top-0 right-0 w-28 md:w-48 opacity-15 pointer-events-none translate-x-8 -translate-y-4 select-none z-0"
      />
      <img
        src={cloudSmall.src}
        alt=""
        aria-hidden="true"
        className="absolute bottom-0 left-0 w-24 md:w-40 opacity-15 pointer-events-none -translate-x-6 translate-y-4 select-none z-0"
      />
