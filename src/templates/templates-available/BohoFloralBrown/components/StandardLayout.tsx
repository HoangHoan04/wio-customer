import dividerImg from "@/assets/decorations/boho-floral-brown/decoration_bar.webp";
...
export const StandardLayout = ({
  ...
  return (
    <div
      className={`transition-opacity duration-1000 ${isEnvelopeOpen ? "opacity-100" : "opacity-0 h-0 overflow-hidden"}`}
    >
      ...
      {isEnvelopeOpen && data.musicUrl && (
        <button
          ...
          style={{
            backgroundColor: config.colors.envelope,
