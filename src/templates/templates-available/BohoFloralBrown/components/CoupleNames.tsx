import decorFlower from "@/assets/decorations/boho-floral-brown/fixed_flower.webp";
  ...
  return (
    <div className=" px-4 flex flex-col items-center text-center relative z-10 overflow-hidden">
      <img
        ...
        alt=""
        aria-hidden="true"
        className="absolute right-0 top-1/2 -translate-y-1/2 w-24 md:w-48 opacity-10 pointer-events-none translate-x-8 select-none z-0"
      />
      {data?.showIntro && (
        <p
