...
import flowerMid from "@/assets/decorations/boho-floral-brown/flower_mid.webp";
import {
  getDayStr,
  getLunarDateStr,
  getMonthStr,
  ...
  return (
    ...
    >
      <img
        src={flowerMid}
        alt="decor"
        className="absolute right-0 top-1/2 -translate-y-1/2 w-40 md:w-56 opacity-25 pointer-events-none translate-x-12 select-none z-0"
      />

      <div className="w-full max-w-xl h-px bg-linear-to-r from-transparent via-[#5d4037] to-transparent opacity-20 mb-12"></div>
      <h2
