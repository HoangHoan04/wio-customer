...
export const HeroImages = ({
  ...
  const renderTopPerson = (person: any) => (
    <div className="relative flex justify-start pl-6">
      <div
        className="relative w-48 h-64 md:w-56 md:h-80 bg-white p-3 pb-12 shadow-[0_15px_35px_rgba(78,54,41,0.15)] rotate-[3deg] z-10 shrink-0 rounded-sm border border-[#ebdccb]/60"
      >
        <img
  ...
  const renderBottomPerson = (person: any) => (
    <div className="relative flex justify-end pr-6 -mt-16 md:-mt-20">
      <div
        className="relative w-48 h-64 md:w-56 md:h-80 bg-white p-3 pb-12 shadow-[0_15px_35px_rgba(78,54,41,0.15)] rotate-[-4deg] z-10 shrink-0 rounded-sm border border-[#ebdccb]/60"
      >
        <img
          src={person?.photo || "https://placehold.co/300x400"}
          alt={person?.name}
