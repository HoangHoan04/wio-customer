  ...
  return (
    <div className="w-full px-6 py-6 flex flex-col items-center">
      <div className="w-full max-w-sm flex flex-col items-center">
        ...
        <h2
          className="text-2xl font-extrabold text-slate-900 mb-6 flex items-center gap-2"
          style={{ fontFamily: config.fonts.heading }}
        >
          <Camera className="size-6 text-amber-500" />
          <span>Hình Ảnh Kỷ Yếu</span>
        </h2>
          ...
          {photos.map((photo: any, idx: number) => {
            ...
            return (
              <div
                ...
                className="aspect-square rounded-2xl overflow-hidden shadow-sm border border-slate-200 cursor-pointer hover:scale-105 transition-transform duration-200"
              >
                <img
                  src={url}
                  alt={`Kỷ yếu ${idx + 1}`}
