...
/** Giao diện theme Boho Floral Brown — sắp xếp và bố cục do file này quyết định. */
export default function BohoFloralBrownRender(props: ThemeRenderProps) {
  const runtime = useBohoFloralBrownTheme(props);
  const { data } = props;
