...
/** Giao diện theme Baby Blush — bố cục giống birthday-coral. */
export default function BabyBlushRender(props: ThemeRenderProps) {
  const runtime = useBabyBlushTheme(props);
  const { data } = props;
