...
/** Giao diện theme Boho Floral Pink — sắp xếp và bố cục do file này quyết định. */
export default function BohoFloralPinkRender(props: ThemeRenderProps) {
  const runtime = useBohoFloralPinkTheme(props);
  const { data } = props;
