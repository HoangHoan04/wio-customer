...
/** Giao diện theme Birthday Coral — bố cục sinh nhật. */
export default function BirthdayCoralRender(props: ThemeRenderProps) {
  const runtime = useBirthdayCoralTheme(props);
  const { data } = props;
