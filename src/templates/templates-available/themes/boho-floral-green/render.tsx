...
/** Giao diện theme Boho Floral Green — sắp xếp và bố cục do file này quyết định. */
export default function BohoFloralGreenRender(props: ThemeRenderProps) {
  const runtime = useBohoFloralGreenTheme(props);
  const { data } = props;
