...
/** Giao diện theme Red Double Happiness — hero single, thứ tự truyền thống. */
export default function RedDoubleHappinessRender(props: ThemeRenderProps) {
  const runtime = useRedDoubleHappinessTheme(props);
  const { data } = props;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <HostsSection {...section} variant="hosts" />
