...
export const Gallery = ({ data, config }: { data?: any; config: ThemeTemplateConfig }) => {
  ...
  return (
    <section className="relative py-1 overflow-hidden" style={{ backgroundColor: config.colors.background }}>
      <img src={cloudBig} alt="" aria-hidden="true" className="absolute top-0 right-0 w-32 md:w-56 opacity-15 pointer-events-none translate-x-12 -translate-y-8 select-none z-0" />
