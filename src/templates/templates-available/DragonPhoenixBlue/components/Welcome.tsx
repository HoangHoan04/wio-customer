...
import dragonStandingImg from "@/assets/decorations/dragon_phoenix_blue/dragon.webp";
import dragonLeftImg from "@/assets/decorations/dragon_phoenix_blue/dragon_left.webp";
import dragonRightImg from "@/assets/decorations/dragon_phoenix_blue/dragon_right.webp";
import phoenixImg from "@/assets/decorations/dragon_phoenix_blue/phoenix.webp";
  ...
  return (
    <div
      style={{
        ...
        background: "radial-gradient(ellipse at center, #162542 0%, #0d1b2a 60%, #060b14 100%)",
