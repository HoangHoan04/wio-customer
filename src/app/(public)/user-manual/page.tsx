      ...
      <div className="text-center max-w-200 mx-auto mb-12">
        <h1
          ...
          style={{
            ...
            background:
              "linear-gradient(135deg, #e5c483 0%, #c5a059 50%, #e5c483 100%)",
      ...
      <section className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div
              className="text-base leading-relaxed font-light space-y-4"
              style={{
                color: "#a38a75",
                fontFamily: "'Cormorant Garamond', serif",
              }}
            >
              <p>
                ...
                . Hệ thống khởi tạo thiệp cưới thông minh giúp bạn tự tay thiết
                kế những mẫu thiệp điện tử độc bản.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-2.5 my-6">
              {features.map((text, i) => (
                <div
                  key={i}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-light tracking-wide transition-all duration-300"
                  style={{
